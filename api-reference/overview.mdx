...
Base URL `https://api.brdg.now/v1`. No API key. Every amount is a string in the asset's atomic units.
...
The OpenAPI 3.1 document is at [`/v1/openapi.json`](https://api.brdg.now/v1/openapi.json). The [TypeScript SDK](/sdk) wraps these seven calls.
