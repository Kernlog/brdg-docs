...
Your share on one transfer is capped at **$10**, converted into the source asset at Bridg's price for it, independently of the platform's own $10 cap. `fees.referral.amountAtomic` is the capped amount.
