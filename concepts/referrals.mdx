...
Your share is charged on every transfer you refer, including one on which BRDG itself charges nothing, and is capped at **$10** per transfer, converted into the source asset at BRDG's price for it. The platform's own $10 cap is separate. `fees.referral.amountAtomic` is the capped amount.
